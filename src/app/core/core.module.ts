...
@NgModule({
  declarations: [LayoutComponent, ContentComponent, ToolbarComponent, IconComponent, NoStyleButtonComponent, IconButtonComponent, SidebarComponent, MenuComponent, ItemsMenuComponent],
  imports: [
    CommonModule,
    RouterModule
  ],
